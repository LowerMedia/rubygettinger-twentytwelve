	...
	<?php endif; ?>
		...
		while ( $meteor_loop->have_posts() ) : $meteor_loop->the_post(); ?>
			...
			<div class="mslide mslide-<?php echo $meteor_count; ?>">
				...
				<?php endif; ?>
			<div id="slideshow-exerpt-wrap"><p id='exerpt-holder'><a href="<?php echo get_post_meta( $post->ID, "slide_url_value", $single = true ); ?>" title="<?php the_title(); ?>"><?php the_excerpt(); ?></a></p></div>
